...
double Hion=HION/1000.0,re=RE_WGS84/1000.0; /* last TEC shell height/radius (km) */
...
extern void readtec(const char *file, nav_t *nav, int opt)
{
    ...
    for (i=0;i<n;i++) {
        ...
        /* read ionex header */
		lats[0]=0;lats[1]=0;lats[2]=0;
		lons[0]=0;lons[1]=0;lons[2]=0;
		hgts[0]=0;hgts[1]=0;hgts[2]=0;
		rb=0.0;
		nexp=-1.0;
