...
typedef struct {        /* navigation data type */
    ...
    double legacy_cbias[MAXSAT][3]; /* GAMP-style DCB [0:P1-P2,1:P1-C1,2:P2-C2] (m) */
...
EXPORT int outsolexs(uint8_t *buff, const sol_t *sol, const ssat_t *ssat,
                     const solopt_t *opt);
EXPORT int outstecs (uint8_t *buff, const rtk_t *rtk, const nav_t *nav,
                     gtime_t time);
EXPORT int outvtecs (uint8_t *buff, const rtk_t *rtk, const nav_t *nav,
                     gtime_t time);
...
EXPORT void outsolex(FILE *fp, const sol_t *sol, const ssat_t *ssat,
                     const solopt_t *opt);
EXPORT void outstec (FILE *fp, const rtk_t *rtk, const nav_t *nav,
                     gtime_t time);
EXPORT void outvtec (FILE *fp, const rtk_t *rtk, const nav_t *nav,
                     gtime_t time);
