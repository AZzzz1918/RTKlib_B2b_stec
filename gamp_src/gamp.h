...
#define OFILE_RESIC1  10      //��һƵ��α��в��IF���α��в�
#define OFILE_RESIP1  11      //��һƵ����λ�в��IF�����λ�в�
#define OFILE_RESIC2  12      //�ڶ�Ƶ��α��в�
#define OFILE_RESIP2  13      //�ڶ�Ƶ����λ�в�
#define OFILE_RESIC3  14      //����Ƶ��α��в�
#define OFILE_RESIP3  15      //����Ƶ����λ�в�
#define OFILE_STEC    16      //��һƵ�ʵ�sTEC
...
#define OFILE_VTEC    22      //��һƵ�ʵ�VTEC
...
#define ND(opt)     ((opt)->nf>=3||(opt)->ionoopt==IONOOPT_UC12?NSYS:0)   /* number of receiver DCB */
...
#define ID(s,opt)     (NP(opt)+NC(opt)+(s))   /* state index of receiver DCB */
...
typedef struct {
	...
	int bElevCheckEx;       //ʹ����չ�ĸ߶Ƚǽ�ȡ�����������ڽ�ֹ�߶Ƚ�ʱʹ�����ݣ������輫С��Ȩֵ
